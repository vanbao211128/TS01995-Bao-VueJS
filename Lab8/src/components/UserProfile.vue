      ...
      <div class="col-lg-4">
        <div class="card mb-4 shadow-sm border-0">
          <div class="card-body text-center">
            ...
            <h5 class="my-3 fw-bold">{{ user.username }}</h5>
        ...
        <div class="card mb-4 mb-lg-0 border-0 shadow-sm">
          <div class="card-body p-0">
            <ul class="list-group list-group-flush rounded-3">
              <router-link to="/profile/info" class="list-group-item list-group-item-action d-flex align-items-center p-3 text-decoration-none">
                  <i class="fas fa-user text-primary"></i>
                  <span class="mb-0 fw-bold">Thông tin cơ bản</span>
              </router-link>

              <router-link to="/profile/settings" class="list-group-item list-group-item-action d-flex align-items-center p-3 text-decoration-none">
                  <i class="fas fa-user text-primary"></i>
                  <span class="mb-0 fw-bold">Cài đặt</span>
              </router-link>
